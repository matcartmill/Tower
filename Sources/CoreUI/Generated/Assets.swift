...
public enum Asset {
  ...
  public enum Icons {
    ...
    public static let emotionHappyFilled = ImageAsset(name: "icons/emotion-happy-filled")
    public static let emotionHappyLine = ImageAsset(name: "icons/emotion-happy-line")
    public static let emotionNeutralFilled = ImageAsset(name: "icons/emotion-neutral-filled")
    public static let emotionNeutralLine = ImageAsset(name: "icons/emotion-neutral-line")
    public static let emotionSadFilled = ImageAsset(name: "icons/emotion-sad-filled")
    public static let emotionSadLine = ImageAsset(name: "icons/emotion-sad-line")
    public static let emotionSmileFilled = ImageAsset(name: "icons/emotion-smile-filled")
    public static let emotionSmileLine = ImageAsset(name: "icons/emotion-smile-line")
